...
const PAGES: { to: string; label: string; group: string }[] = [
  ...
  { to: '/sales/transactions',    label: 'Invoice Summary', group: 'Sales' },
  { to: '/sales/journals',        label: 'Invoice Details', group: 'Sales' },
  ...
  // Accounting LAST (owner request 26 Jul 2026) — full set of 8 pages.
  { to: '/accounting/journal',        label: 'Journal',        group: 'Accounting' },
  { to: '/accounting/trial-balance',  label: 'Trial Balance',  group: 'Accounting' },
