  ...
  return (
    <Box sx={{ pt: 0, px: 3, pb: 3 }}>
      <Box sx={{ position:'sticky', top:0, zIndex:10, bgcolor: 'var(--rt-surface-2)',
        ...
        <Typography variant="h6" sx={{ fontWeight:700, fontSize:20, color: 'var(--rt-text)', letterSpacing:'-0.3px', mb:1.5 }}>{tr('Store Intelligence')}<TitleLoader /></Typography>
      ...
      <Box sx={{ bgcolor: 'var(--rt-surface)', borderRadius:2, border:'1px solid var(--rt-border)', p:2 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="center" mb={1.5}>
          ...
          <GridExportBar gridRef={gridRef} filename="stores" title="Store Intelligence"
            reportEndpoint="/api/sales/perf/stores" reportPeriod="custom" reportParams={params}
